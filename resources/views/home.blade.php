                    ...
                    <div class="swiper-wrapper">
                        @for($i = 0; $i < 10; $i++)
                            <a href="#" class="nav-link category-item swiper-slide">
                                <img src="{{ asset('/frontend/images/icon-vegetables-broccoli.png') }}" alt="Category Thumbnail">
                                <h3 class="category-title">Fruits & Veges - {{ $i }}</h3>
                            </a>
                        @endfor
                    </div>
                </div>
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <a href="#" class="btn-wishlist">
                                                <i style="font-size: 32px" class="bi bi-suit-heart"></i>
                                            </a>
                                            <figure>
                                                <a href="#" title="Product Title">
                                                    <img src="{{ asset('/frontend/images/thumb-bananas.png') }}" class="tab-image" alt="">
                                                </a>
                                            </figure>
                                ...
                                @for($i = 0; $i < 10; $i++)
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="" title="Product Title">
                                                    <img src="{{ asset('/frontend/images/thumb-cucumber.png') }}" class="tab-image">
                                                </a>
                                            </figure>
                                            <h3>Sunstar Fresh Melon Juice</h3>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="banner-ad bg-danger mb-3"
                     style="background: url('/frontend/images/ad-image-3.png');background-repeat: no-repeat;background-position: right bottom;">
            ...
            <div class="col-md-6">
                <div class="banner-ad bg-info"
                     style="background: url('/frontend/images/ad-image-4.png');background-repeat: no-repeat;background-position: right bottom;">
                    <div class="banner-content p-5">
                    ...
                    <div class="swiper-wrapper">
                        @for($i=0; $i < 10; $i++)
                            <div class="product-item swiper-slide">
                                ...
                                <figure>
                                    <a href="#" title="Product Title">
                                        <img src="{{ asset('/frontend/images/thumb-tomatoes.png') }}" class="tab-image" alt="">
                                    </a>
                                </figure>
                                <h3>Sunstar Fresh Melon Juice</h3>
                                <span class="qty">1 Unit</span>
...
<section class="py-5">
    <div class="container-fluid">
        <div class="bg-secondary py-5 my-5 rounded-5" style="background: url('/frontend/images/bg-leaves-img-pattern.png') no-repeat;">
        ...
        <div class="row">
            <div class="col-md-4">
                <article class="post-item card border-0 shadow-sm p-3">
                    <div class="image-holder zoom-effect">
                        <a href="#">
                            <img src="{{ asset('/frontend/images/post-thumb-1.jpg') }}" alt="post" class="card-img-top">
                        </a>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <article class="post-item card border-0 shadow-sm p-3">
                    <div class="image-holder zoom-effect">
                        <a href="#">
                            <img src="{{ asset('/frontend/images/post-thumb-2.jpg') }}" alt="post" class="card-img-top">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
            ...
            <div class="col-md-4">
                <article class="post-item card border-0 shadow-sm p-3">
                    <div class="image-holder zoom-effect">
                        <a href="#">
                            <img src="{{ asset('/frontend/images/post-thumb-3.jpg') }}" alt="post" class="card-img-top">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
